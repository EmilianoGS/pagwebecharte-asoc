...
<header id="<?php if (isset($_GET['id'])){
                       if (($_GET['id'])==3){
                           ...
                           ?>">
  <div id="cabecera">
      <a href="index.php"><div id="<?php if (isset($_GET['id'])){
                       if (($_GET['id'])==3){
                                 $seccion='logo_lemano';
                                 }else{
                                  $seccion='logo_lema';
      ...
      <div id="<?php if (isset($_GET['id'])){
                       if (($_GET['id'])==3){
                           ...
                           ?>">
         <a href="index.php?menu=1&<?php if (isset($_GET['id'])){
        ...
        <nav id="<?php if (!isset($_GET['menu'])){
                           ...
                           ?>">
       <a href="index.php?menu=0&<?php if (isset($_GET['id'])){
          $seccion4='id='.$_GET['id']; if (isset($_GET['id2'])){
                                                               $seccion4.='&id2='.$_GET['id2'];}
       ...
       $seccion2='cerrar';
        ...
        $seccion2='cerrarno';
     	 ...
     	 <ul id="secciones">
  		  <li id="liboton"><a id="botones_header" href="index.php?id=1">INICIO</a></li>
          <li id="liboton"><a id="<?php if (isset($_GET['id'])){
                       if (($_GET['id'])==2){
                           ...
                           ?>" href="index.php?id=2">SERVICIOS</a></li>
          <li id="liboton" ><a id="<?php if (isset($_GET['id'])){
                       if (($_GET['id'])==3){
                                 $seccion='liboton2';
                                 }else{
                           ...
                           ?>"href="index.php?id=3">NOSOTROS</a></li>
          <li id="liboton"><a id="<?php if (isset($_GET['id'])){
                       if (($_GET['id'])==4){
                                 $seccion='liboton2';
                                 }else{
                           ...
                           ?>" href="index.php?id=4">CONTACTO</a></li>
     	 </ul>
...
?>">
 ...
 <!-- <iframe src=slider401.html id="sliderhtml" ></iframe> -->
  ...
  <!--<a href="index.php?id=2"><div id="masinfo">Mas informacion</div></a> -->
  ...
  <div id="areaservicios">
        ...
        <div id="serv1y2">
              <div id="iconos">
                 ...
                 <a id="boton4" href="index.php?id=2&id2=4">
                   <div id="laboral">
              ...
              <div id="div_clear"></div>
         <a href="index.php?id=2"><div id="vermas_serv">Ver más</div></a>
        </div>  
...
Siguiendo esa línea, no obstante sus logros acumulados, su visión apunta a muchos años de vigor en el campo de su conocimiento, aplicando los mismos en los casos particulares que aquejan a sus clientes, buscando soluciones eficientes, personalizadas y de máxima confidencialidad.
     ...
     <div id="contenido_nosotros">
      ...
      <div id="nombre_perfil"><span><h1>Dr. Marcos José Echarte</h1></span><article>Abogado (Tomo 137 Folio 127 del Colegio Público de Abogados de la Capital Federal).</article><br><br><p><span><strong>Contacto:</strong>
...
<section id="<?php if(isset($_GET['id'])){
                       if (($_GET['id'])==2){
                             $seccion='section_servicio';
                                 ...
                                 echo $seccion;?>">
  <div id="nuestros_servicios"><a href="index.php?id=2"><p>Nuestros servicios</p></a></div>
  <nav id="botonera_servicios">
    <ul>
     
       <li id="normal"><a href="index.php?id=2&id2=1"><p>Derecho Penal</h4></p></a></li>
    
    
     
       <li id="normal"><a href="index.php?id=2&id2=2"><p>Derecho de Familia</p></a></li>
    
    
   
       <li id="normal"><a href="index.php?id=2&id2=3"><p>Derecho Civil</p></a></li>
      
     
    
       <li id="boton4"><a id="boton4" href="index.php?id=2&id2=4"><p>Derecho Laboral</p></a></li>
          ...
          <?php if(isset($_GET['id2'])){
             ...
             <?php } else{?>
               ...
               <!-- <a id="vinculo_sliderh" href="index.php?id=4"><div id="vinculo"></div></a>-->
              
            <?php }
            ?>

<div id="asistencia">
  <div id="texto_asistencia"><p>¿Necesitas asesoramiento? Consultanos</p><a id="contactar_serv" href="index.php?id=4"><div>Contactar</div></a></div>
...
<footer>
  ...
  <span id="contactopie">
        <div id="contenedor_pie">
           ...
           <nav id="botonera_pie">
             <ul id="secciones_pie">
              <li><a id="botones_pie" href="index.php?id=1"><p>Inicio</p></a></li>
              <li><a id="botones_pie" href="index.php?id=2"><p>Servicio</p></a></li>
              <li><a id="botones_pie" href="index.php?id=3"><p>Nosotros</p></a></li>
              <li><a id="botones_pie" href="index.php?id=4"><p>Contacto</p></a></li>
             </ul>
           </nav>
        </div>
         <div id="div_clear"></div>
